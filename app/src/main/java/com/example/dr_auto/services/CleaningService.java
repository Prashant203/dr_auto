...
public class CleaningService extends AppCompatActivity implements ItemArrayAdapter.ServiceProviderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.settings.setOnClickListener(v -> startActivity(new Intent(CleaningService.this, MyAcount.class)));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, response -> {
                    ...
                    if (itemList.size() > 0) {
                        ...
                        arrayAdapter = new ItemArrayAdapter(itemList, CleaningService.this);
                        recyclerView.setLayoutManager(new LinearLayoutManager(CleaningService.this));
