...
public class TyresService extends AppCompatActivity implements ItemArrayAdapter.ServiceProviderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.settings.setOnClickListener(v -> startActivity(new Intent(TyresService.this, MyAcount.class)));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, response -> {
                    ...
                    if (itemList.size() > 0) {
                        ...
                        arrayAdapter = new ItemArrayAdapter(itemList, TyresService.this);
                        recyclerView.setLayoutManager(new LinearLayoutManager(TyresService.this));
