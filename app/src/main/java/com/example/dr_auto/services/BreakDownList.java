...
public class BreakDownList extends AppCompatActivity implements ItemArrayAdapter.ServiceProviderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.settings.setOnClickListener(v -> startActivity(new Intent(BreakDownList.this, MyAcount.class)));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, response -> {
                    ...
                    if (itemList.size() > 0) {
                        ...
                        arrayAdapter = new ItemArrayAdapter(itemList, BreakDownList.this);
                        recyclerView.setLayoutManager(new LinearLayoutManager(BreakDownList.this));
