...
public class LightsService extends AppCompatActivity implements ItemArrayAdapter.ServiceProviderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.settings.setOnClickListener(v -> startActivity(new Intent(LightsService.this, MyAcount.class)));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, response -> {
                    ...
                    if (itemList.size() > 0) {
                        ...
                        arrayAdapter = new ItemArrayAdapter(itemList, LightsService.this);
                        recyclerView.setLayoutManager(new LinearLayoutManager(LightsService.this));
