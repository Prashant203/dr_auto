...
public class DentService extends AppCompatActivity implements ItemArrayAdapter.ServiceProviderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.settings.setOnClickListener(v -> startActivity(new Intent(DentService.this, MyAcount.class)));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, response -> {
                    ...
                    if (itemList.size() > 0) {
                        ...
                        arrayAdapter = new ItemArrayAdapter(itemList, DentService.this);
                        recyclerView.setLayoutManager(new LinearLayoutManager(DentService.this));
